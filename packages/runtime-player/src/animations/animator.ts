...
// Previously a hand-mirrored copy (authoring's mirror lived in
// AnimationPropertiesPanel). `contractGuards.ts` fails the build if a local
// redefinition reappears.

export type { AnimationKeypoint, AnimationFill, AnimationPath } from '@elearn-studio/shared-types'

import type { AnimationKeypoint, AnimationPath } from '@elearn-studio/shared-types'
